      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-5 pb-16 pt-14 sm:px-8 sm:pb-20 sm:pt-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-8 lg:pb-24 lg:pt-24">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              href="#pilot"
              className="inline-flex items-center justify-center gap-2 bg-accent px-6 py-3.5 text-sm font-bold uppercase tracking-wide text-accent-ink transition-colors hover:bg-accent-dark"
            >
